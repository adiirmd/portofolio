...
export const profile: Profile = {
  ...
  bio: 'Saya seorang praktisi IT yang berfokus pada infrastruktur, administrasi server, sistem operasi, serta jaringan dan routing. Saat ini saya menangani operasional infrastruktur data center, memastikan ketersediaan layanan tetap terjaga dan setiap insiden tertangani dengan cepat. Di luar itu saya menaruh minat besar pada cyber security dan terbiasa merancang automasi untuk menyederhanakan pekerjaan operasional yang berulang.',
  experience: [
    {
      title: 'Data Center Operator',
      company: 'Jedi Global Teknologi (Placement: Bank BTPN Syariah)',
      duration: 'Sekarang',
    },
    {
