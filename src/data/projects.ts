...
export const projects: Project[] = [
  {
    ...
    description:
      "Sistem pencatatan keuangan pribadi yang berjalan otomatis. Setiap notifikasi transaksi pada ponsel diteruskan ke webhook lalu ditulis langsung ke Google Sheets. Dilengkapi dashboard web untuk penyuntingan manual serta bot Telegram yang mengirim rekap harian pukul 23.58 dan peringatan setiap pengeluaran mencapai kelipatan 50 ribu sebagai alat kontrol finansial.",
